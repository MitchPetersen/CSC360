...
void readFreeBlockVector(FILE* disk, int* findFreeBlock){      // block 1 - 8
	int signal = 0;
...
void fillFreeBlockVector(FILE* disk, int fillBlockNumber){      // block 1 - 8
...
void delete_free_block_vector(FILE* disk, int deleteBlock){      // block 1 - 8
